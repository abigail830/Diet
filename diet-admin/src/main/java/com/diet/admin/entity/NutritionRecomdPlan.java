 ...
 */ 
@Entity
@Table(name = "tb_nutrition_recomd_plan")
public class NutritionRecomdPlan extends BaseEntity {
	 ...
	 * 当月推荐体重
	 */ 
	@Column(name = "curMonthWeight")
	private Float curMonthWeight;
	...
	public Float getCurMonthWeight(){
		return curMonthWeight;
	}

	public void setCurMonthWeight(Float curMonthWeight){
		this.curMonthWeight=curMonthWeight;
	}
